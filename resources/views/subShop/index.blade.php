    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Shop SubCategories</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-list mr-2"></i>Shop SubCategories</a>
        </li>
        @can('clothesCategories.create')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('shopsubcategory.create') !!}"><i class="fa fa-plus mr-2"></i>Create Shop SubCategories</a>
        </li>
        @endcan
        ...
        <table class="table table-striped" >
          ...
          <tbody>
              @foreach ($subcategories as $subcategory)
                  ...
                  <td>{{$subcategory->shopCategory? $subcategory->shopCategory->name : ''}}</td>
