...
<!-- Id Field -->
<div class="form-group row col-md-4 col-sm-12">
    {!! Form::label('shop', trans('lang.shop'), ['class' => 'col-4 control-label']) !!}
    <div class="col-8">
        @if(isset($order->clothesOrders[0]))
            <p>{!! $order->clothesOrders[0]->clothes->shop->name !!}</p>
        @endif
    </div>

    {!! Form::label('shop_address', trans('lang.shop_address'), ['class' => 'col-4 control-label']) !!}
    <div class="col-8">
        @if(isset($order->clothesOrders[0]))
            <p>{!! $order->clothesOrders[0]->clothes->shop->address !!}</p>
        @endif
    </div>

    {!! Form::label('shop_phone', trans('lang.shop_phone'), ['class' => 'col-4 control-label']) !!}
    <div class="col-8">
        @if(isset($order->clothesOrders[0]))
            <p>{!! $order->clothesOrders[0]->clothes->shop->phone !!}</p>
        @endif
    </div>
