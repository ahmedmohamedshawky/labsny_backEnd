...
class ShopReviewsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('shop_reviews')->delete();

        factory(\App\Models\ShopReview::class,20)->create();
        
//        \DB::table('shop_reviews')->insert(array (
//            0 =>
//            array (
//                'id' => 1,
