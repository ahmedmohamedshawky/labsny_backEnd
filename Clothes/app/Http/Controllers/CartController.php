...
class CartController extends Controller
{
    ...
    public function __construct(CartRepository $cartRepo, CustomFieldRepository $customFieldRepo, ClothesRepository $clothesRepo
    ...
    public function create()
    {
        ...
        return view('carts.create')->with("customFields", isset($html) ? $html : false)->with("clothes", $clothes)->with("user", $user)->with("extra", $extra)->with("extrasSelected", $extrasSelected);
    }
    ...
    public function edit($id)
    {
        ...
        return view('carts.edit')->with('cart', $cart)->with("customFields", isset($html) ? $html : false)->with("clothes", $clothes)->with("user", $user)->with("extra", $extra)->with("extrasSelected", $extrasSelected);
    }
