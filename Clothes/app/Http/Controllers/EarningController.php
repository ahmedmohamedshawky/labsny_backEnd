...
private $shopRepository;
    ...
    public function __construct(EarningRepository $earningRepo, CustomFieldRepository $customFieldRepo , ShopRepository $shopRepo, OrderRepository $orderRepository)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        foreach ($shops as $shop){
            $shopId = $shop->id;
            $this->earningRepository->firstOrCreate(['shop_id'=>$shopId])->first();
        }
    ...
    public function edit($id)
    {
        ...
        return view('earnings.edit')->with('earning', $earning)->with("customFields", isset($html) ? $html : false)->with("shop",$shop);
    }
