    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    <div class="inner">
                        <h3>{{$shopsCount}}</h3>
                        <p>{{trans('lang.shop_plural')}}</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-cutlery"></i>
                    </div>
                    <a href="{!! route('shops.index') !!}" class="small-box-footer">{{trans('lang.dashboard_more_info')}} <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header no-border">
                        <h3 class="card-title">{{trans('lang.shop_plural')}}</h3>
                        <div class="card-tools">
                            <a href="{{route('shops.index')}}" class="btn btn-tool btn-sm"><i class="fa fa-bars"></i> </a>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <table class="table table-striped table-valign-middle">
                            <thead>
                            <tr>
                                <th>{{trans('lang.shop_image')}}</th>
                                <th>{{trans('lang.shop')}}</th>
                                <th>{{trans('lang.shop_address')}}</th>
                            ...
                            @foreach($shops as $shop)
                                ...
                                <tr>
                                    <td>
                                        {!! getMediaColumn($shop, 'image','img-circle img-size-32 mr-2') !!}
                                    </td>
                                    <td>{!! $shop->name !!}</td>
                                    <td>
                                        {!! $shop->address !!}
                                    ...
                                    <td class="text-center">
                                        <a href="{!! route('shops.edit',$shop->id) !!}" class="text-muted"> <i class="fa fa-edit"></i> </a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
