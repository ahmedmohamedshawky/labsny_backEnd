...
<div class="form-group row ">
  {!! Form::label('clothes_id', trans("lang.cart_clothes_id"),['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::select('clothes_id', $clothes, null, ['class' => 'select2 form-control']) !!}
    <div class="form-text text-muted">{{ trans("lang.cart_clothes_id_help") }}</div>
  </div>
</div>
