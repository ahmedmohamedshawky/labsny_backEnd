...
<!-- Image Fit Field -->
    ...
    <!-- Clothes Id Field -->
    <div class="form-group row ">
        {!! Form::label('clothes_id', trans("lang.slide_clothes_id"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('clothes_id', $clothes, null, ['data-empty'=>trans("lang.slide_clothes_id_placeholder"),'class' => 'select2 not-required form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.slide_clothes_id_help") }}</div>
        </div>
    </div>

    <!-- Shop Id Field -->
    <div class="form-group row ">
        {!! Form::label('shop_id', trans("lang.slide_shop_id"),['data-empty'=>trans("lang.slide_shop_id_placeholder"),'class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('shop_id', $shop, null, ['class' => 'select2 not-required form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.slide_shop_id_help") }}</div>
        </div>
    </div>
