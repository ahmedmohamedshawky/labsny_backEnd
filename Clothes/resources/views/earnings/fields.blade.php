...
<div class="form-group row ">
  {!! Form::label('shop_id', trans("lang.earning_shop_id"),['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::select('shop_id', $shop, null, ['class' => 'select2 form-control']) !!}
    <div class="form-text text-muted">{{ trans("lang.earning_shop_id_help") }}</div>
  </div>
</div>
...
<!-- Shop Earning Field -->
<div class="form-group row ">
  {!! Form::label('shop_earning', trans("lang.earning_shop_earning"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::number('shop_earning', null,  ['class' => 'form-control','placeholder'=>  trans("lang.earning_shop_earning_placeholder")]) !!}
    <div class="form-text text-muted">
      {{ trans("lang.earning_shop_earning_help") }}
    </div>
  </div>
</div>
