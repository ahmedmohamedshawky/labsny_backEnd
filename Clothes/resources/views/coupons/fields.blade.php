...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
  ...
  <!-- Clothes Id Field -->
  <div class="form-group row ">
    {!! Form::label('clothes[]', trans("lang.coupon_clothes_id"),['class' => 'col-3 control-label text-right']) !!}
    <div class="col-9">
      {!! Form::select('clothes[]', $clothes, $clothesSelected, ['class' => 'select2 form-control', 'multiple'=>'multiple']) !!}
      <div class="form-text text-muted">{{ trans("lang.coupon_clothes_id_help") }}</div>
    </div>
  </div>

<!-- Shop Id Field -->
<div class="form-group row ">
  {!! Form::label('shops', trans("lang.coupon_shop_id"),['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::select('shops[]', $shop, $shopsSelected, ['class' => 'select2 form-control', 'multiple'=>'multiple']) !!}
    <div class="form-text text-muted">{{ trans("lang.coupon_shop_id_help") }}</div>
  </div>
</div>
