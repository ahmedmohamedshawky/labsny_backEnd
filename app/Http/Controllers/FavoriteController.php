...
class FavoriteController extends Controller
{
    ...
    public function __construct(FavoriteRepository $favoriteRepo, CustomFieldRepository $customFieldRepo, ClothesRepository $clothesRepo
    ...
    public function create()
    {
        ...
        return view('favorites.create')->with("customFields", isset($html) ? $html : false)->with("clothes", $clothes)->with("extra", $extra)->with("extrasSelected", $extrasSelected)->with("user", $user);
    }
    ...
    public function edit($id)
    {
        ...
        return view('favorites.edit')->with('favorite', $favorite)->with("customFields", isset($html) ? $html : false)->with("clothes", $clothes)->with("extra", $extra)->with("extrasSelected", $extrasSelected)->with("user", $user);
    }
