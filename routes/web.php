...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['middleware' => ['permission:app-settings']], function () {
        Route::prefix('settings')->group(function () {
            ...
            Route::patch('offers', 'AppSettingController@offers');
    ...
    Route::post('shops/remove-media', 'ShopController@removeMedia');
    Route::get('requestedShops', 'ShopController@requestedShops')->name('requestedShops.index'); //adeed
    Route::resource('shops', 'ShopController')->except([
        'show'
    ]);
    ...
    Route::post('clothes/remove-media', 'ClothesController@removeMedia');
    Route::resource('clothes', 'ClothesController')->except([
        'show'
    ]);
    ...
    Route::resource('clothesReviews', 'ClothesReviewController')->except([
        'show'
    ]);
    ...
    Route::resource('shopReviews', 'ShopReviewController')->except([
        'show'
    ]);
    ...
    Route::resource('shopsPayouts', 'ShopsPayoutController')->except([
        'show', 'edit', 'update'
    ]);
    ...
    Route::resource('colourCategories', 'ColourCategoryController')->except([
        'show'
    ]);

    Route::resource('sizeCategories', 'SizeCategoryController')->except([
        'show'
    ]);

    Route::resource('clothesCategories', 'ClothesCategoryController')->except([
        'show'
    ]);
